...
<a href="/goods/getGoodsByStyle.do?style=${style}&newStart=0">首页</a>&nbsp;
<a href="/goods/getGoodsByStyle.do?style=${style}&newStart=${pre}">上一页</a>&nbsp;
<a href="/goods/getGoodsByStyle.do?style=${style}&newStart=${next}">下一页</a>&nbsp;
<a href="/goods/getGoodsByStyle.do?style=${style}&newStart=${last}">尾页</a>&nbsp;
