...
<div class="servicesBox">
    <c:forEach items="${styles}" var="temp" varStatus="st">
        <div class="serBox">
...
<a href="/goods/searchGoods.do?product=${product}&newStart=0">首页</a>&nbsp;
<a href="/goods/searchGoods.do?product=${product}&newStart=${pre}">上一页</a>&nbsp;
<a href="/goods/searchGoods.do?product=${product}&newStart=${next}">下一页</a>&nbsp;
<a href="/goods/searchGoods.do?product=${product}&newStart=${last}">尾页</a>&nbsp;
